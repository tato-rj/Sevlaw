<section class="container mb-6">
	...
	<div class="row pt-4">
		<div class="col-lg-8 col-md-8 col-12 text-right">
			...
			@include('principal.components.quem-row', [
				'title' => 'Negócios Familiares',
				'text' => 'Uma de nossas especialidades está no trabalho com empresas familiares, com planejamentos de negócios e planejamento sucessório.',
				'mb' => 0])
		</div>
